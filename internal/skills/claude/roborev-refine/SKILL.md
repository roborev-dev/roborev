...
Launch the explicit review as a background task using the `Task` tool with
...
9. Waits ~2s, runs `roborev show --ref HEAD --json` — hook already enqueued job 1043, verdict Pass
