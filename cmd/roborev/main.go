...
func registerAgentCompletion(cmd *cobra.Command) {
	if err := cmd.RegisterFlagCompletionFunc("agent", func(_ *cobra.Command, _ []string, _ string) ([]string, cobra.ShellCompDirective) {
...
func registerReasoningCompletion(cmd *cobra.Command) {
	if err := cmd.RegisterFlagCompletionFunc("reasoning", func(_ *cobra.Command, _ []string, _ string) ([]string, cobra.ShellCompDirective) {
